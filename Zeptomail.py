...
def main():
    ...
    CONFIG = {
        ...
        'gdrive_folder_id': '1UztLKOp-job-BeKqcLV16dPLBlF1cV19',  # Optional: Google Drive folder ID to upload to
        'sender': 'procurement@zeptonow.com',  # Email address to search from
